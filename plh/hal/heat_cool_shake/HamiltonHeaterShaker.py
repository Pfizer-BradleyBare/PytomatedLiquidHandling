...
class HamiltonHeaterShaker(HeatCoolShakeABC):
    ...
    def Initialize(self):
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.CreateUSBDevice.Response,
        )
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.SetPlateLock.Response,
        )
    ...
    def Deinitialize(self):
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.StopTempCtrl.Response,
        )
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.StopShaker.Response,
        )
    ...
    def SetTemperature(self, Temperature: float):
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.StartTempCtrl.Response,
        )
    ...
    def GetTemperature(self) -> float:
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.GetTemperature.Response,
        )
    ...
    def SetShakingSpeed(self, RPM: int):
        if RPM == 0:
            ...
            ResponseInstance = self.Backend.GetResponse(
                CommandInstance,
                HeaterShakerDriver.StartShaker.Response,
            )
    ...
    def GetShakingSpeed(self) -> int:
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterShakerDriver.GetShakerSpeed.Response,
        )
