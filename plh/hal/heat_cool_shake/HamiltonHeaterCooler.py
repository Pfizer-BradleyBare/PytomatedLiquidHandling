...
class HamiltonHeaterCooler(HeatCoolShakeABC):
    ...
    def Initialize(self):
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterCoolerDriver.Connect.Response,
        )
    ...
    def Deinitialize(self):
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterCoolerDriver.StopTemperatureControl.Response,
        )
    ...
    def SetTemperature(self, Temperature: float):
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterCoolerDriver.SetTemperature.Response,
        )
    ...
    def GetTemperature(
        ...
        ResponseInstance = self.Backend.GetResponse(
            CommandInstance,
            HeaterCoolerDriver.GetTemperature.Response,
        )
