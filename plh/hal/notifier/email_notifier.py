...
class EmailConversation(ConversationBase):
    ...
    """We use the latest message as an easy way to parse responses."""

    contacts: list[EmailContact]
    """Typed contacts"""

    reference: str
    """This is the message-ID of the message generated by ```start_conversation```. This allows us to create email threads."""
