...
class VantageTrackGripperEntryExit(HamiltonBackendABC):
    MethodPath: str = field(
        init=False,
        default="C:\\Program Files (x86)\\HAMILTON\\Library\\PytomatedLiquidHandling\\PytomatedLiquidHandling\\Driver\\Hamilton\\Backend\\VantageTrackGripperEntryExit\\Method\\BasicMethod.med",
    )
