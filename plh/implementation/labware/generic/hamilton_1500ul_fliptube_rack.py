...
class Hamilton1500uLFliptubeRack(PipettableLabware):
    def __init__(self: Hamilton1500uLFliptubeRack, identifier: str = "Hamilton1500uLFliptubeRack"):
        super().__init__(
