...
class HamiltonPortraitCORE8Channel(PipetteABC):
    ...
    def Transfer(
        ...
        for OptionsList in Options:
            ...
            Counter = 0
            NumOptions = len(OptionsList)
            while Counter < NumOptions:
                GroupedOptions.append(OptionsList[Counter : Counter + 8])
                Counter += 8
                    ...
                    ListedPickupOptions.append(
                        PortraitCORE8Channel.Pickup.Options(
                            LabwareID=TipPositions[
                                PipetteTipInstance.Tip.Identifier
                            ].pop(0)["LabwareID"],
