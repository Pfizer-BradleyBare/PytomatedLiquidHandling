...
def Step(step):
	...
	if not all(Location > 0 and Location <= SAMPLES.GetNumSamples() for Location in AliquotLocations):
		MethodComments.append("The Aspirate Location parameter you provided exceeds the total number of samples. This parameter is less than or equal to the number of samples and greater than 0. Please Correct")
