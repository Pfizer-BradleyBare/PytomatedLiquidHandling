...
def Step(step):
	...
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Starting Vacuum Block. Block Coordinates: " + str(step.GetCoordinates())}),False,True)
	...
	if not (TITLE in STEPS.GetPreviousStepInPathway(step).GetTitle()):
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Moving collection plate into vacuum manifold"}),False,True)		
		...
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Moving vacuum plate atop vacuum manifold"}),False,True)
		...
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Previous block was a Vacuum block. Vacuum plate and collection plate are already in place"}),False,True)
		HAMILTONIO.SendCommands()
	...
	if LiquidTransferFlag == True:
		...
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Pipetting source into vacuum plate"}),False,True)
	...
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Adding block to timer list to wait for " + str(WaitTime) + " minutes"}),False,True)
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Ending Vacuum Block. Block Coordinates: " + str(step.GetCoordinates())}),False,True)
	HAMILTONIO.SendCommands()
...
def PreVacuumWaitCallback(step):
	...
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Performing first follow up of Vacuum Block. Block Coordinates: " + str(step.GetCoordinates())}),False,True)
	HAMILTONIO.SendCommands()
	...
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Starting vaccum with a " + PressureString}),False,True)
	...
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Ending first follow up of Vacuum Block. Block Coordinates: " + str(step.GetCoordinates())}),False,True)
	HAMILTONIO.SendCommands()
...
def VacuumWaitCallback(step):
	...
	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Performing second follow up of Vacuum Block. Block Coordinates: " + str(step.GetCoordinates())}),False,True)
	HAMILTONIO.SendCommands()
	...
	if not (TITLE in STEPS.GetNextStepInPathway(step).GetTitle()):
		...
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Removing vaccum plate from atop vacuum manifold"}),False,True)
		...
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Removing collection plate from vacuum manifold"}),False,True)
		...
		HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Vacuum plate and collection plate will not be moved. Next block is also a Vacuum block"}),False,True)
		HAMILTONIO.SendCommands()

	HAMILTONIO.AddCommand(STATUS_UPDATE.AddProgressDetail({"DetailMessage": "Ending second follow up of Vacuum Block. Block Coordinates: " + str(step.GetCoordinates())}),False,True)
	HAMILTONIO.SendCommands()
